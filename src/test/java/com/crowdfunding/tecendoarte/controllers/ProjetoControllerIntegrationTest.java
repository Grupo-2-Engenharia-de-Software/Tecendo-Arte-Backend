...
class ProjetoControllerIntegrationTest {
    ...
    void setUp() {
        ...
        artista = Artista.builder()
                ...
                .tiposArte(List.of(com.crowdfunding.tecendoarte.models.enums.TipoArte.PINTURA))
                .build();
    ...
    void deveCadastrarProjetoComSucesso() throws Exception {
        ...
        SecurityContextHolder.getContext().setAuthentication(
                new UsernamePasswordAuthenticationToken(artista.getEmail(), null, List.of())
        );

        mockMvc.perform(post("/projetos")
                        .principal(() -> artista.getEmail())
    ...
    void deveBuscarProjetoPorIdComSucesso() throws Exception {
        Projeto projeto = Projeto.builder()
                ...
                .meta(500.0)
                .tipoArte(com.crowdfunding.tecendoarte.models.enums.TipoArte.PINTURA)
                .artista(artista)
                .dataCriacao(LocalDate.now())
                .status(com.crowdfunding.tecendoarte.models.enums.StatusProjeto.AGUARDANDO_AVALIACAO)
                .valorArrecadado(0.0)
                .build();
    ...
    void deveConsultarProjetosPorArtista() throws Exception {
        ...
        Projeto projeto2 = Projeto.builder()
                ...
                .meta(200.0)
                .tipoArte(com.crowdfunding.tecendoarte.models.enums.TipoArte.ESCULTURA)
                .artista(artista)
                .dataCriacao(LocalDate.now())
                .status(com.crowdfunding.tecendoarte.models.enums.StatusProjeto.AGUARDANDO_AVALIACAO)
                .valorArrecadado(0.0)
